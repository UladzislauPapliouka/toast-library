import React, { useContext, useMemo, useRef, useDebugValue, createElement, useState, useImperativeHandle, useEffect } from 'react';
...
const titleTextSizesMixin = (sizeName, sizes) => Ae`
    ...
    max-width: ${sizes.toastMaxWidth[sizeName] - sizes.paddingSizes[sizeName] * 2 - sizes.titleFontSizes[sizeName] * 2 - sizes.iconSizes[sizeName] - sizes.marginSizes[sizeName]}px;
`;
const descriptionTextSizesMixin = (sizeName, sizes) => Ae`
    font-size: ${sizes.descriptionFontSizes[sizeName]}px;
    max-width: ${sizes.toastMaxWidth[sizeName] - sizes.paddingSizes[sizeName] * 4 - sizes.titleFontSizes[sizeName] - sizes.iconSizes[sizeName] - sizes.marginSizes[sizeName]}px;
`;
...
}) => closeButtonSizesMixin('xxl', sizes)};
    @media screen and (max-width: ${({
  theme: {
    sizes
  }
...
}) => closeButtonSizesMixin('xl', sizes)};
    }
    @media screen and (max-width: ${({
  theme: {
    sizes
...
}) => closeButtonSizesMixin('lg', sizes)};
    }
    @media screen and (max-width: ${({
  theme: {
    sizes
...
}) => closeButtonSizesMixin('md', sizes)};
    }
    @media screen and (max-width: ${({
  theme: {
    sizes
...
}) => closeButtonSizesMixin('sm', sizes)};
    }
`;
...
}) => descriptionTextSizesMixin('xxl', sizes)};
    @media screen and (max-width: ${({
  theme: {
    sizes
  }
...
}) => descriptionTextSizesMixin('xl', sizes)};
    }
    @media screen and (max-width: ${({
  theme: {
    sizes
...
}) => descriptionTextSizesMixin('lg', sizes)};
    }
    @media screen and (max-width: ${({
  theme: {
    sizes
...
}) => descriptionTextSizesMixin('md', sizes)};
    }
    @media screen and (max-width: ${({
  theme: {
    sizes
...
}) => descriptionTextSizesMixin('sm', sizes)};
    }
`;
...
function Toast({
  ...
  }, toastIcons[type], /*#__PURE__*/React.createElement(ToastDataWrapper, null, /*#__PURE__*/React.createElement(ToastTitle, null, toastTitle.slice(0, 29)), toastDescription && /*#__PURE__*/React.createElement(ToastDescription, null, toastDescription.slice(0, 89))), /*#__PURE__*/React.createElement(CloseButton, {
    onClick: e => {
      e.stopPropagation();
      handleClose();
    }
...
var singleton$1 = new Singleton$1();
...
var sizes = /*#__PURE__*/Object.freeze({
  __proto__: null,
  borderRadiuses: borderRadiuses,
  descriptionFontSizes: descriptionFontSizes,
  displayBreackpoints: displayBreackpoints,
  iconSizes: iconSizes,
  marginSizes: marginSizes,
  paddingSizes: paddingSizes,
  titleFontSizes: titleFontSizes,
  toastMaxHeight: toastMaxHeight,
  ...
  useImperativeHandle(ref, () => ({
    createNewToast(newToast) {
      if (toasts.filter(t => t.position === newToast.position).length < 3) {
        ...
        setTimeout(() => this.removeToast(newToast.id, newToast.position), newToast.duration);
      }
    },
    removeToast: toastId => {
      setToasts(prevState => prevState.filter(toast => toastId !== toast.id));
    }
  }));
  useEffect(() => {
...
const ToastContainer = () => {
  ...
  return /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(Le, {
    theme: {
      colors: singleton$1.toastTheme,
      sizes,
      containerMargin: singleton$1.getInstance().containerMargin
    }
  }, /*#__PURE__*/React.createElement(ToastContainerWrapper, null, Object.keys(positions).map(positionName => /*#__PURE__*/React.createElement(ToastPositionWrapper, {
    key: positionName,
    onClick: () => singleton$1.getInstance().createToast({
      title: 'rddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd',
      position: positions[positionName],
      type: 'info',
      animationName: 'slide',
      description: 'dffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'
    }),
    "data-cy": positions[positionName]
  }, toasts.map(t => t.position === positions[positionName] ? /*#__PURE__*/React.createElement(Toast, {
    key: t.id,
    toastTitle: t.title,
    ...
    handleClose: () => singleton$1.getInstance().removeToast(t.id)

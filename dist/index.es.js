import React, { Component, useState, useRef, useImperativeHandle, useEffect } from 'react';
...
class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return state.error ? /*#__PURE__*/React.createElement(ErrorWrapper, null, /*#__PURE__*/React.createElement(ErrorMessage, null, state.error.message), /*#__PURE__*/React.createElement(ErrorComponentStack, null, state.errorInfo.componentStack)) : props.children;
  }
}
...
const ToastContainer = () => {
  ...
  return /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(ErrorBoundary, null, /*#__PURE__*/React.createElement(ThemeProvider, {
    theme: {
      colors: singleton.toastTheme,
      sizes,
      containerMargin: singleton.getInstance().containerMargin
    }
  }, /*#__PURE__*/React.createElement(ToastContainerWrapper, null, Object.keys(positions$1).map(positionName => /*#__PURE__*/React.createElement(ToastPositionWrapper, {
    key: positionName,
    "data-cy": positions$1[positionName]
  }, toasts.map(t => t.position === positions$1[positionName] ? /*#__PURE__*/React.createElement(Toast, {
    key: t.id,
    toastTitle: t.title,
    ...
    handleClose: () => singleton.getInstance().removeToast(t.id)
